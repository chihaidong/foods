...
function stpetx(p)
{
	...
	if(nNN4||!nDM)
		...
		s+="<iframe id='masklayer' src='javascript:false' marginheight='0' marginwidth='0' frameborder='0' style='position:absolute; visibility:inherit; top:0px; left:0px; width:100%; height:100%; z-index:-1; filter='progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)';'></iframe></TD></TABLE>";
	else
		s+="</DIV>";
	return s;
}
