...
/*
	[插件名称] 供应信息检索 - 替换模版的{#modSellQuery#}
	[适用范围] 文章分类检索页
	[文 件 名] SellQuery.php
	[更新时间] 2006/9/20
*/
...
function SellQuery(){
	...
	$pages->setvar(array("tp" => $tp,"showtj" => $showtj,"infotime" => $infotime,"key" => $key,"catid" => $catid,"zoneid" => $zoneid,"Province" => $Province));
