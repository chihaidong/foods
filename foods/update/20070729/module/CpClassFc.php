...
/*
	[插件名称] 图文下一级分类 - 替换模版标签{#modCpClassFc#}
	[适用范围] 图文检索页(显示当前类别的下一级类别,适合显示在检索上方)
	[文 件 名] CpClassFc.php
	[更新时间] 2006/8/3
*/
...
function CpClassFc(){
		...
		global $msql,$tbl_cp_cat,$CatchOpen,$DetailCatch;
		global $strCpClass,$NowCatid,$NowMenuid,$MenuInfo;



		$PSET=PlusSet("modCpClassFc");
