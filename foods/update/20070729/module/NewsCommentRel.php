...
/*
	[插件名称] 文章相关评论 - 替换模版标签{#modNewsCommentRel#}
	[适用范围] 文章详情页
	[文 件 名] NewsCommentRel.php
	[更新时间] 2007/3/27
*/

function NewsCommentRel(){

	global $fsql,$tsql,$charset,$tbl_comment,$CatchOpen;
	global $strMore,$NowMenuid,$MenuInfo,$NowNewsId;

		$PSET=PlusSet("modNewsCommentRel");
		...
		$showmenuid=MenuDef("news",$NowMenuid);


		//$scl=" fabu='1' and coltype='news' and pid='0' ";
		$scl=" fabu='1' and coltype='news' and pid='0' and rid='$NowNewsId'";
		...
		if($showmenuid!="0" && $showmenuid!=""){
			...
			$morelink=ROOTPATH."comment.php?coltype=news";
