...
/*
	[插件名称] 本类最新下载 - 替换模版标签{#modDownSameCat#}
	[适用范围] 文章检索页,详情页
	[文 件 名] DownSameCat.php
	[更新时间] 2006/8/5
*/


function DownSameCat(){

	global $fsql,$charset,$tbl_down_con,$CatchOpen;
	global $strMore,$PAGEINFO,$NowCatid,$NowMenuid,$MenuInfo;

		$catid=$NowCatid;

		$PSET=PlusSet("modDownSameCat");
