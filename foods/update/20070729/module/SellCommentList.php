...
/*
	[插件名称] 信息相关评论 - 替换模版标签{#modSellCommentList#}
	[适用范围] 信息详情页
	[文 件 名] SellCommentList.php
	[更新时间] 2006/11/13
*/

function SellCommentList(){

	global $fsql,$tsql,$charset,$tbl_comment,$CatchOpen;
	global $strMore,$NowInfoId,$NowMenuid,$MenuInfo;

		$PSET=PlusSet("modSellCommentList");
		...
		$scl=" fabu='1' and coltype='sell' and pid='0' and rid='$NowInfoId'";

		$morelink=ROOTPATH."comment.php?coltype=sell&rid=$NowInfoId";
