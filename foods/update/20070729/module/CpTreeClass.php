...
/*
	[插件名称] 图文树型分类菜单 - 替换模版标签{#modCpTreeClass#}
	[适用范围] 所有页面
	[文 件 名] CpTreeClass.php
	[更新时间] 2006/7/30
*/


function CpTreeClass(){

		global $msql,$tbl_cp_cat,$CatchOpen,$MenuInfo;
		global $NowMenuid,$strSelClass;

		$PSET=PlusSet("modCpTreeClass");
