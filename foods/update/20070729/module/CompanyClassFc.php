...
/*
	[插件名称] 餐馆下一级分类 - 替换模版标签{#modCompanyClassFc#}
	[适用范围] 检索页(显示当前类别的下一级类别)
	[文 件 名] CompanyClassFc.php
	[更新时间] 2006/9/18
*/



function CompanyClassFc(){
		...
		$PSET=PlusSet("modCompanyClassFc");
		...
		$msql->query("select * from $tbl_member_cat where $scl order by $ord $sc");
		$i=0;
