...
/*
	[插件名称] 文章频道相关图文 - 替换模版标签{#modNewsCpPicRel#}
	[适用范围] 文章详情页
	[文 件 名] CpNewsPicRel.php
	[更新时间] 2006/8/5
*/


function NewsCpPicRel(){

	global $fsql,$charset,$tbl_cp_con,$tbl_news_con,$CatchOpen;
	global $NowNewsId,$MenuInfo;
	global $strMore;

	$id=$NowNewsId;

	$PSET=PlusSet("modNewsCpPicRel");
