...
/*
	[插件名称] 最新餐馆评论 - 替换模版标签{#modCompanyCommentListAll#}
	[适用范围] 全站
	[文 件 名] CompanyCommentListAll.php
	[更新时间] 2006/11/15
*/

function CompanyCommentListAll(){

	global $fsql,$charset,$tbl_comment,$CatchOpen;
	global $strMore,$NowMenuid,$MenuInfo;

		$PSET=PlusSet("modCompanyCommentListAll");
		...
		$scl=" fabu='1' and coltype='company' and pid='0'";

		$morelink=ROOTPATH."comment.php?coltype=company";
