...
/*
	[插件名称] 文章频道相关下载 - 替换模版标签{#modNewsDownRel#}
	[适用范围] 文章详情页
	[文 件 名] NewsDownRel.php
	[更新时间] 2006/8/5
*/


function NewsDownRel(){

	global $fsql,$charset,$tbl_down_con,$tbl_news_con,$CatchOpen;
	global $strMore,$NowNewsId,$MenuInfo;

	$id=$NowNewsId;

	$PSET=PlusSet("modNewsDownRel");
