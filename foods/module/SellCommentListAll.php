...
/*
	[插件名称] 最新信息评论 - 替换模版标签{#modSellCommentListAll#}
	[适用范围] 全站
	[文 件 名] SellCommentListAll.php
	[更新时间] 2006/11/15
*/

function SellCommentListAll(){

	global $fsql,$charset,$tbl_comment,$CatchOpen;
	global $strMore,$NowMenuid,$MenuInfo;

		$PSET=PlusSet("modSellCommentListAll");
		...
		$scl=" fabu='1' and coltype='sell' and pid='0' ";

		$morelink=ROOTPATH."comment.php?coltype=sell";
