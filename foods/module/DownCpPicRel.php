...
/*
	[插件名称] 下载频道相关图文 - 替换模版标签{#modDownCpPicRel#}
	[适用范围] 下载详情页
	[文 件 名] CpDownPicRel.php
	[更新时间] 2006/8/5
*/


function DownCpPicRel(){

	global $fsql,$charset,$tbl_cp_con,$tbl_down_con,$CatchOpen,$MenuInfo;
	global $NowDownId;
	global $strMore;

	$id=$NowDownId;

	$PSET=PlusSet("modDownCpPicRel");
	...
	$tempname=PlusDef($PSET["tempname"],"tpl_cppic.htm");
		...
		$scl=" iffb='1' and src!='' and type!='swf' and ( id=0 ";
