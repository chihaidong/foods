...
/*
	[插件名称] 下载频道同专题相关文章 - 替换模版标签{#modDownNewsRel#}
	[适用范围] 下载频道详情页
	[文 件 名] DownNewsRel.php
	[更新时间] 2006/8/5
*/


function DownNewsRel(){

	global $fsql,$charset,$tbl_news_con,$tbl_down_con,$CatchOpen;
	global $strMore,$NowDownId,$MenuInfo;

	$id=$NowDownId;

	$PSET=PlusSet("modDownNewsRel");
