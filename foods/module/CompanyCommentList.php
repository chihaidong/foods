...
/*
	[插件名称] 餐馆相关评论 - 替换模版标签{#modCompanyCommentList#}
	[适用范围] 餐馆主页
	[文 件 名] CompanyCommentList.php
	[更新时间] 2006/11/5
*/
...
function CompanyCommentList(){
	...
	global $strMore,$NowCompanyId,$NowMenuid,$MenuInfo;

		$PSET=PlusSet("modCompanyCommentList");
		...
		$scl=" fabu='1' and coltype='company' and pid='0' and rid='$NowCompanyId'";

		$morelink=ROOTPATH."comment.php?coltype=company&rid=$NowCompanyId";
